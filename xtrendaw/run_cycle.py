            ...
            try:
                ...
                if _lp.exists() and not args.force:
                    ...
                    if time.time() - float(_ts) < 3000:
                        ...
                        # ممنوع تفريغ الـvault هنا: الدورة المتزامنة لازم لا تنشر
                        # حلقتين في نفس الساعة. الإفراج يحصل مرة واحدة فقط بعد
                        # إنتاج الدورة الناجحة أو عند موعد السلسلة التالي.
                        return 42
