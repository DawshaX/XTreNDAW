...
QURAN = [
    ...
    dict(id="duha", surah=93, frm=1, to=11,
         scenes=["morning sun rays window", "dawn city quiet",
                 "sunrise field light", "orphans playing dawn"] ),
    ...
    dict(id="fil", surah=105, frm=1, to=5,
         scenes=["birds flock sky sunset", "desert stones ground",
                 "old mosque architecture", "ancient army desert"]),
    dict(id="quraish", surah=106, frm=1, to=4,
         scenes=["camel caravan desert", "old mecca street",
                 "trade market ancient", "desert night stars"]),
    dict(id="maun", surah=107, frm=1, to=7,
         scenes=["wheat field golden", "bread oven old",
                 "orphan street ancient", "water jug clay"]),
    ...
    dict(id="nasr", surah=110, frm=1, to=3,
         scenes=["crowd praying mosque", "sunrise mountains gold",
...
QISSA = [
    ...
    {"id": "hudhud", "title": "الهدهد وملكة سبأ", "surah": 27, "frm": 20, "to": 28, "scenes": ["hoopoe bird flying", "ancient queen throne palace", "letter scroll royal seal", "sunrise ancient temple", "majestic kingdom gold"]},
    ...
    dict(id="ibrahim-birds", title="طيور إبراهيم", surah=2, frm=260, to=260,
         scenes=["birds flock mountains", "four birds sky",
                 "ancient prophet desert", "birds flying dawn"]),
]
...
TAFASEER = [
    ...
    dict(id="t-duha", surah=93, frm=1, to=11,
         scenes=["morning sun rays window", "dawn city quiet",
                 "sunrise field light", "orphan child smile"]),
...
def produce_din(kind: str, workdir: Path, reciter_idx: int = 0,
    ...
    if kind in ("quran", "qissa", "tafsir", "juz", "ruqyah", "tahseen"):
        ...
        qs = {
            ...
            "akhlaq": ["helping hands kindness", "bread table warm light",
