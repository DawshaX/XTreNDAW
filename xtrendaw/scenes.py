...
PALETTES = {
    ...
    "nawawi_c": {"bg": ("#100c04", "#241c0c"), "neon": "#d8c8a0", "neon2": "#a89860"},
    "ruqyah_c": {"bg": ("#04120c", "#0c281c"), "neon": "#7fe0b0", "neon2": "#40a878"},
    "hisn_c": {"bg": ("#041012", "#0c2428"), "neon": "#8fd0d8", "neon2": "#5098a8"},
    "tahseen_c": {"bg": ("#121004", "#282208"), "neon": "#e0c87f", "neon2": "#a89040"},
    "qudsi_c": {"bg": ("#0c0414", "#1c0c30"), "neon": "#c0a0e0", "neon2": "#8060b0"},
}
